            ...
            <div class="swiper-slide">
              <div class="tpproduct p-relative">
                <div class="tpproduct__thumb p-relative text-center">
                  <a href="#"><img src="<?php echo "admin1/" . $row["img_path"]; ?>" style="height: 200px;" alt="" ></a>
                    <a class="tpproduct__thumb-img" href="shop-details.html"><img src="<?php echo  "admin1/" . $row["img_path"]; ?>" alt=""></a>
                ...
                <div class="tpproduct__content">
                  <span class="tpproduct__content-weight">
                    <a href="shop-details.html"><?php echo $row["brand"] ?></a>
                  </span>
                  <h4 class="tpproduct__title">
                    <a href="shop-details-3.html"><?php echo $row["title"]; ?></a>
                  </h4>
