...
?>
  <?php if ($result->num_rows > 0) {
   ...
   <form action="assets/add-to-cart.php" method="post">
<div class="col item" data-category="<?php echo $row['category'] ?>">
   <div class="tpproduct p-relative mb-20">
      ...
      <div class="tpproduct__hover-text">
         ...
         <button class="tp-btn-2" name="add" type="submit">Add to cart</button>
         </div>
