...
if (isset($_POST['submit'])) {
  ...
  $target_dir = "assets/category-upload/"; // Directory where the file will be stored
  ...
  if ($uploadOk == 0) {
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
      ...
      if (isset($_GET['edit_id'])) {
        ...
        $sql = "UPDATE category SET category='$category',img_path='$target_file' WHERE id='$edit_id'";
      } else {
                          ...
                          <div class="col-md-4">
                            <div class="basic-form">
                              <div class="form-group">
                                ...
                                <input name="category" type="text" class="form-control border-none input-flat bg-ash" value="<?php echo $row['category']; ?>">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="basic-form">
                              <div class="form-group">
                                ...
                                <img src="<?php echo $row['img_path']; ?>" height="200px" width="200px" alt="">
                              </div>
                            </div>
                          </div>
