...
if (isset($_POST['submit'])) {
  ...
  if ($uploadOk == 0) {
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
      ...
      $sql = "INSERT INTO category (`category`, `name`) VALUES ('$category', '$target_file')";
                      ...
                      <div class="col-md-4">
                        <div class="basic-form">
                          <div class="form-group">
                            ...
                            <input name="category" type="text" class="form-control border-none input-flat bg-ash" placeholder="Enter brand">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4">
