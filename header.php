      ...
      <header>
                        ...
                        <div class="header__menu main-menu text-center">
                           <nav id="mobile-menu">
                              <ul>
                                 ...
                                 <li class=" has-megamenu" >
                                    <a href="about.php">Latest Collection</a>
                                 </li>
                                 <li class=" has-megamenu" >
                     ...
                     <div class="col-xl-3">
                        <div class="header__info d-flex align-items-center">
                           ...
                           <div class="header__info-user tpcolor__yellow ml-10">
                              <a href="log-in.php"><i class="icon-user"></i></a>
                           </div>
                           ...
                           <div class="header__info-cart tpcolor__oasis ml-10 ">
                              <a href="cart.php"><i><img src="assets/img/icon/cart-1.svg" alt=""></i></a>
                           </div>
                           <!-- <div class="header__info-cart tpcolor__oasis ml-10 tp-cart-toggle">
                              <button><a href="cart.php"><i><img src="assets/img/icon/cart-1.svg" alt=""></i></a>
                                 <span>5</span>
                              </button>
                           </div> -->
                        </div>
         ...
         <div class="tpsideinfo">
            ...
            <div class="tpsideinfo__account-link">							
               <a href="log-in.php"><i class="icon-user icons"></i> Login / Register</a>
            </div>
